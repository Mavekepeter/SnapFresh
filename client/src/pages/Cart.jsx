...
const Cart = () => {
    ...
    const {getCartCount,getCartAmount,updateCartItem,
     removeFromCart,cartItems,navigate,products,currency,user,setCartItems} = useAppContext();
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        <div className="flex items-center md:gap-6 gap-3">
                            <div onClick={()=>{
                                navigate(`/products/
                                    ${product.category.toLowerCase()}/${product._id}`);scrollTo(0,0)
                        ...
                        <button className="cursor-pointer mx-auto">
                            <img onClick={()=>removeFromCart(product._id)} src={assets.remove_icon} 
